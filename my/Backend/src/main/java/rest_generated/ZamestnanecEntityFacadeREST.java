...
import persistence.ZamestnanecEntity;
...
public class ZamestnanecEntityFacadeREST extends AbstractFacade<ZamestnanecEntity> {
	...
	public ZamestnanecEntity find(@PathParam("id") Long id) {
	...
	@GET
        @Override
        @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
	public List<ZamestnanecEntity> findAll() {
	...
	@GET
        @Path("{from}/{to}")
        @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
	public List<ZamestnanecEntity> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
